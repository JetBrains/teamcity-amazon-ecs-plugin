...
class EcsDataCacheImpl : EcsDataCache {
    private val entryExpirationTimeout: Int = TeamCityProperties.getInteger(CACHE_EXPIRATION_TIMEOUT_PROPERTY, 10 * 1000)
    ...
    override fun getInstanceStatus(taskArn: String, resolver: () -> InstanceStatus): InstanceStatus {
        ...
        synchronized(cache){
            ...
            if(cacheEntry == null || (now - cacheEntry.timestamp) > entryExpirationTimeout){
